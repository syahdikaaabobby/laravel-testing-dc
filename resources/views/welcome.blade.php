...
<body class="bg-slate-900 text-slate-100 font-sans antialiased">
    ...
    <section id="pricing" class="py-20">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
                ...
                <div class="bg-slate-800/40 rounded-3xl p-8 border {{ $plan['popular'] ? 'border-blue-500 shadow-2xl shadow-blue-500/10 relative' : 'border-slate-800' }} flex flex-col justify-between">
                    @if($plan['popular'])
    ...
    <footer class="bg-slate-950 border-t border-slate-800 py-12">
        <div class="max-w-7xl mx-auto px-6 text-center text-slate-500 text-sm">
            <p>&copy; {{ date('Y') }} CloudHost. All rights reserved. Dummy Laravel Web Hosting Project.</p>
        </div>
    </footer>
